...
export const countries: Country[] = [
  // ── EUROPE ──
  {
    ...
    restaurants: [
      { id: "tonys-pizza-napoletana", name: "Tony's Pizza Napoletana", neighborhood: "North Beach" },
      { id: "cotogna", name: "Cotogna", neighborhood: "Jackson Square" },
    ],
  },
  {
    id: "france",
    ...
    restaurants: [
      { id: "cafe-claude", name: "Café Claude", neighborhood: "Union Square" },
      { id: "petit-crenn", name: "Petit Crenn", neighborhood: "Hayes Valley" },
    ],
  },
  {
    id: "spain",
    ...
    restaurants: [
      { id: "bocadillos", name: "Bocadillos", neighborhood: "Jackson Square" },
      { id: "coqueta", name: "Coqueta", neighborhood: "Embarcadero" },
    ],
  },
  // ── NORTH AMERICA ──
  {
    ...
    restaurants: [
      { id: "la-taqueria", name: "La Taqueria", neighborhood: "Mission" },
      { id: "nopalito", name: "Nopalito", neighborhood: "Inner Sunset" },
    ],
  },
  // ── SOUTH AMERICA ──
  {
    ...
    restaurants: [
      { id: "limon-rotisserie", name: "Limón Rotisserie", neighborhood: "Mission" },
      { id: "pasion", name: "Pasión", neighborhood: "Mission" },
    ],
  },
  {
    id: "argentina",
    ...
    restaurants: [
      { id: "lolinda", name: "Lolinda", neighborhood: "Mission" },
    ],
  },
  // ── ASIA ──
  {
    ...
    restaurants: [
      { id: "mister-jius", name: "Mister Jiu's", neighborhood: "Chinatown" },
      { id: "yank-sing", name: "Yank Sing", neighborhood: "SoMa" },
    ],
  },
  {
    id: "japan",
    ...
    restaurants: [
      { id: "rintaro", name: "Rintaro", neighborhood: "Mission" },
      { id: "robin", name: "Robin", neighborhood: "Hayes Valley" },
    ],
  },
  {
    id: "korea",
    ...
    restaurants: [
      { id: "san-ho-won", name: "San Ho Won", neighborhood: "Mission" },
      { id: "toyose", name: "Toyose", neighborhood: "Outer Sunset" },
    ],
  },
  {
    id: "thailand",
    ...
    restaurants: [
      { id: "kin-khao", name: "Kin Khao", neighborhood: "Union Square" },
      { id: "lers-ros", name: "Lers Ros", neighborhood: "Hayes Valley" },
    ],
  },
  {
    id: "vietnam",
    ...
    restaurants: [
      { id: "turtle-tower", name: "Turtle Tower", neighborhood: "Tenderloin" },
      { id: "saigon-sandwich", name: "Saigon Sandwich", neighborhood: "Tenderloin" },
    ],
  },
  {
    id: "india",
    ...
    restaurants: [
      { id: "dosa", name: "DOSA", neighborhood: "Fillmore" },
      { id: "besharam", name: "Besharam", neighborhood: "Dogpatch" },
    ],
  },
  {
    id: "burma",
    ...
    restaurants: [
      { id: "burma-superstar", name: "Burma Superstar", neighborhood: "Inner Richmond" },
      { id: "mandalay", name: "Mandalay", neighborhood: "Inner Richmond" },
    ],
  },
  {
    id: "philippines",
    ...
    restaurants: [
      { id: "abaca", name: "Abacá", neighborhood: "Marina" },
    ],
  },
  // ── MIDDLE EAST ──
  {
    ...
    restaurants: [
      { id: "beit-rima", name: "Beit Rima", neighborhood: "Castro" },
    ],
  },
  {
    id: "yemen",
    ...
    restaurants: [
      { id: "saba", name: "Saba", neighborhood: "Tenderloin" },
    ],
  },
  {
    id: "israel",
  ...
  // ── AFRICA ──
  {
    ...
    restaurants: [
      { id: "moya-restaurant", name: "Moya Restaurant", neighborhood: "Mission" },
      { id: "axum-cafe", name: "Axum Cafe", neighborhood: "Lower Haight" },
    ],
  },
];
